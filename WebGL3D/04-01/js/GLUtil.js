 ...
 * @param shaderScript
 */
function loadingSingleShader(ctx, shaderScript) {
...
function loadShaderSerial(gl,vshader,fshader) {
    var vertexShader = loadingSingleShader(gl, vshader); // 加载顶点着色器

    var fragmentShader = loadingSingleShader(gl, fshader);// 加载片元着色器
