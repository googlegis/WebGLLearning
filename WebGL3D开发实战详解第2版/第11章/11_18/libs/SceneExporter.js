	...
	parse: function ( scene ) {
		...
		function GeometryString( g ) {
			...
			if ( g instanceof THREE.SphereGeometry ) {
				...
				g.parameters.widthSegments? '	"widthSegments"  : ' + g.parameters.widthSegments + ',' : '',
				g.parameters.heightSegments?'	"heightSegments" : ' + g.parameters.heightSegments : '',
				'}'
				...
				g.widthSegments?'	"widthSegments"  : ' + g.widthSegments + ',':'',
				g.heightSegments?'	"heightSegments" : ' + g.heightSegments + ',':'',
				g.depthSegments?'	"depthSegments" : '  + g.depthSegments:'',
				'}'
		...
		function MaterialString( m ) {
			...
			if (m instanceof THREE.MeshBasicMaterial) {
				...
				var output = [
					...
					m.ambient ? '		"ambient"  : ' + m.ambient.getHex() + ',' : '',
					m.map ? '		"map" : ' + LabelString(getTextureName(m.map)) + ',' : '',
					m.envMap ? '		"envMap" : ' + LabelString(getTextureName(m.envMap)) + ',' : '',
					m.specularMap ? '		"specularMap" : ' + LabelString(getTextureName(m.specularMap)) + ',' : '',
					m.lightMap ? '		"lightMap" : ' + LabelString(getTextureName(m.lightMap)) + ',' : '',
