   function MatrixState()
   {
   	  ...
   	  this.cameraFB = new Array(3);//存储摄像机位置的数组
	  ...
	  this.setCamera = function (
		  ...
		  upx,upy,upz //摄像机up向量的x、y、z分量
	  ) {
		setLookAtM(this.mVMatrix,0,cx,cy,cz,tx,ty,tz,upx,upy,upz);//产生摄像机观察矩阵
		this.cameraFB[0] = cx;//存储摄像机x坐标
		this.cameraFB[1] = cy;//存储摄像机y坐标
		this.cameraFB[2] = cz;//存储摄像机z坐标
	  }
